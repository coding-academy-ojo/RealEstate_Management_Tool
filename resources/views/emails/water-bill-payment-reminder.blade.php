...
<head>
    ...
    <title>Water Bill Payment Reminder</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>💧 Water Bill Payment Reminder</h1>
    </div>
    ...
    <div class="content">
        ...
        <p>This is a reminder that you have unpaid water bills that are due by the end of the month.</p>
        ...
        <p style="background-color: #fff3cd; padding: 15px; border-radius: 5px; margin-top: 20px;">
            <strong>💡 Tip:</strong> You can filter unpaid bills on the Water Services page to quickly identify which
