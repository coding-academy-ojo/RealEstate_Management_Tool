            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('lands.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="governorate" id="governorate" value="{{ old('governorate') }}">
                        <input type="hidden" name="region" id="region" value="{{ old('region') }}">

                        <!-- Governorate Selection -->
                        <div class="mb-4">
                            <label for="governorate_filter" class="form-label fw-bold">
                                Governorate <span class="text-danger">*</span>
                            </label>
                            <select id="governorate_filter" class="form-select" required>
                                <option value="">-- Select Governorate --</option>
                                <optgroup label="Region 1 - Capital">
                                    <option value="AM" {{ old('governorate_filter') == 'AM' ? 'selected' : '' }}>Amman
                                        (عمّان)</option>
                                </optgroup>
                                <optgroup label="Region 2 - North">
                                    <option value="IR" {{ old('governorate_filter') == 'IR' ? 'selected' : '' }}>Irbid
                                        (إربد)</option>
                                    <option value="MF" {{ old('governorate_filter') == 'MF' ? 'selected' : '' }}>Mafraq
                                        (المفرق)</option>
                                    <option value="AJ" {{ old('governorate_filter') == 'AJ' ? 'selected' : '' }}>Ajloun
                                        (عجلون)</option>
                                    <option value="JA" {{ old('governorate_filter') == 'JA' ? 'selected' : '' }}>Jerash
                                        (جرش)</option>
                                </optgroup>
                                <optgroup label="Region 3 - Middle">
                                    <option value="BA" {{ old('governorate_filter') == 'BA' ? 'selected' : '' }}>Balqa
                                        (البلقاء)</option>
                                    <option value="ZA" {{ old('governorate_filter') == 'ZA' ? 'selected' : '' }}>Zarqa
                                        (الزرقاء)</option>
                                    <option value="MA" {{ old('governorate_filter') == 'MA' ? 'selected' : '' }}>Madaba
                                        (مادبا)</option>
                                </optgroup>
                                <optgroup label="Region 4 - South">
                                    <option value="AQ" {{ old('governorate_filter') == 'AQ' ? 'selected' : '' }}>Aqaba
                                        (العقبة)</option>
                                    <option value="KA" {{ old('governorate_filter') == 'KA' ? 'selected' : '' }}>Karak
                                        (الكرك)</option>
                                    <option value="TF" {{ old('governorate_filter') == 'TF' ? 'selected' : '' }}>
                                        Tafileh (الطفيلة)</option>
                                    <option value="MN" {{ old('governorate_filter') == 'MN' ? 'selected' : '' }}>Ma'an
                                        (معان)</option>
                                </optgroup>
                            </select>
                            <small class="text-muted">Select governorate to filter sites</small>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="directorate" id="directorate"
                                    ...
                                    value="{{ old('directorate') }}" required>
                                @error('directorate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="directorate_number" id="directorate_number"
                                    ...
                                    value="{{ old('directorate_number') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="basin" id="basin"
                                    class="form-control @error('basin') is-invalid @enderror" value="{{ old('basin') }}"
                                    required>
                                @error('basin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="basin_number" id="basin_number"
                                    ...
                                    value="{{ old('basin_number') }}" required>
                                @error('basin_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="plot_number" id="plot_number"
                                    ...
                                    value="{{ old('plot_number') }}" required>
                                @error('plot_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="number" step="0.01" name="area_m2" id="area_m2"
                                    ...
                                    value="{{ old('area_m2') }}" required min="0">
                                @error('area_m2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                    ...
                                    @foreach ($zoningStatuses as $status)
                                        <label class="zoning-option" data-name="{{ strtolower($status->name_ar) }}">
                                            <input type="checkbox" class="zoning-checkbox" name="zoning_statuses[]"
                                                ...
                                                {{ in_array($status->id, old('zoning_statuses', [])) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.0000001" name="latitude" id="latitude"
                                    ...
                                    value="{{ old('latitude') }}" placeholder="e.g., 31.9539">
                                @error('latitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.0000001" name="longitude" id="longitude"
                                    ...
                                    value="{{ old('longitude') }}" placeholder="e.g., 35.9106">
                                @error('longitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> You can upload ownership documents, site plans, and photos after creating
                            the land.
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-orange">
                                <i class="bi bi-check-circle me-1"></i> Create Land
                            </button>
                        </div>
                    </form>
                </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const governorateFilter = document.getElementById('governorate_filter');
            ...
            // Governorate full names mapping (English only)
            ...
            governorateFilter.addEventListener('change', function() {
                ...
                if (selectedGovernorate) {
                    // Enable site dropdown
                    siteSelect.disabled = false;

                    // Filter sites by governorate
                    const filteredSites = allSites.filter(site => site.governorate === selectedGovernorate);
                    ...
                    if (filteredSites.length > 0) {
                        ...
                        const option = document.createElement('option');
                        option.value = '';
                        option.textContent = 'No sites available for this governorate';
            ...
            siteSelect.addEventListener('change', function() {
                ...
                if (selectedSiteId) {
                    ...
                    if (selectedSite) {
                        // Use full governorate name instead of code
                        governorateInput.value = governorateNames[selectedSite.governorate] || selectedSite
                            .governorate;
            ...
            // Handle pre-selected site (from old() or request)
            @if (old('site_id') || request('site_id'))
                const preSelectedSiteId = {{ old('site_id', request('site_id')) }};
                const preSelectedSite = allSites.find(site => site.id == preSelectedSiteId);

                if (preSelectedSite) {
                    // Set governorate
                    governorateFilter.value = preSelectedSite.governorate;
                    governorateFilter.dispatchEvent(new Event('change'));

                    // Small delay to ensure site dropdown is populated
                    setTimeout(() => {
                        siteSelect.value = preSelectedSiteId;
                        siteSelect.dispatchEvent(new Event('change'));

                        // Lock site and governorate if coming from site page
                        @if (request('site_id'))
                            siteSelect.disabled = true;
                            governorateFilter.disabled = true;
                        @endif
                    }, 100);
                }
            @endif
