        ...
        <div class="error-card">
            ...
            <div class="error-content-section">
                ...
                <p class="error-message">
                    An unexpected error has occurred. Please try again or return to the dashboard.
                </p>
                ...
                <div class="additional-info">
                    <div class="info-item">
                        ...
                        <small>If this problem continues, please contact support with the details below.</small>
                    </div>
                    @if (isset($exception) && config('app.debug'))
                        <div class="info-item">
                            <i class="bi bi-bug"></i>
                            <small><strong>Error:</strong> {{ $exception->getMessage() }}</small>
                        </div>
                    @endif
                </div>
            </div>
