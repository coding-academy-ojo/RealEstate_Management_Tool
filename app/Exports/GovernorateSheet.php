...
class GovernorateSheet implements FromArray, WithHeadings, WithStyles, WithEvents, WithTitle
{
    ...
    {
        // Return full governorate name in English
    ...
    public function array(): array
    {
        ...
        Site::where('governorate', $this->governorate)
            ->with(['lands.zoningStatuses', 'buildings.lands', 'buildings.waterServices.waterCompany', 'buildings.electricityServices.electricityCompany'])
            ->orderBy('code')
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Make Site Code (B), Land Plot (F), and Building Code (R) columns bold with background colors
